...
const Privacy = () => {
  return (
    <div>
      ...
      <h3 className="mt-4 text-xl font-bold">Interpretation</h3>
      <p className="mb-8 mt-2">
      ...
      <h3 className="mt-4 text-xl font-bold">Definitions</h3>
      <p className="mb-8 mt-2">For the purposes of this Privacy Policy:</p>
      <ul className="list-disc list-inside flex flex-col pl-4 my-4">
        ...
        <li className="mb-2">
          ...
          this Agreement) refers to JobsTracker.
        </li>
        <li className="mb-2">
        ...
        <li className="mb-2">
          <strong>Countries</strong> refers to: All countries of the European
          Union
        </li>
        <li className="mb-2">
      ...
      <h3 className="mt-4 text-xl font-bold">Types of Data Collected</h3>
      <h4 className="mt-2 text-lg font-bold">Personal Data</h4>
      <p className="mb-8 mt-2">
      ...
      <h4 className="mt-2 text-lg font-bold">Usage Data</h4>
      <p className="mb-8 mt-2">
      ...
      <ul className="list-none list-inside flex flex-col pl-4 my-4">
        <li className="mb-2">
          <p className="mb-8 mt-2">
            <strong>Necessary / Essential Cookies</strong>
          </p>
          <p className="mb-8 mt-2">Type: Session Cookies</p>
          <p className="mb-8 mt-2">Administered by: Us</p>
          <p className="mb-8 mt-2">
        ...
        <li className="mb-2">
          ...
          <p className="mb-8 mt-2">Type: Persistent Cookies</p>
          <p className="mb-8 mt-2">Administered by: Us</p>
          <p className="mb-8 mt-2">
      ...
      <h3 className="mt-4 text-xl font-bold">Transfer of Your Personal Data</h3>
      <p className="mb-8 mt-2">
      ...
      <h3 className="mt-4 text-xl font-bold">Delete Your Personal Data</h3>
      <p className="mb-8 mt-2">
      ...
      <h4 className="mt-2 text-lg font-bold">Business Transactions</h4>
      <p className="mb-8 mt-2">
      ...
      <h4 className="mt-2 text-lg font-bold">Law enforcement</h4>
      <p className="mb-8 mt-2">
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h4 className="mt-2 text-lg font-bold">Other legal requirements</h4>
      <p className="mb-8 mt-2">
      ...
      <h3 className="mt-4 text-xl font-bold">Security of Your Personal Data</h3>
      <p className="mb-8 mt-2">
      ...
      <p className="mb-8 mt-2">
        ...
        third party&#39;ss site. We strongly advise You to review the Privacy
